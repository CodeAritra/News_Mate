    ...
    <div className="max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden my-4">
      <img
        src={
          img
            ? img
            : "https://timesofindia.indiatimes.com/thumb/msid-81560824,width-600,height-400,resizemode-4/81560824.jpg"
        }
        alt="img"
      />
      <div className="px-4 py-2">
        ...
        <div className="text-gray-600 font-bold mt-1 text-xs md:text-lg">
